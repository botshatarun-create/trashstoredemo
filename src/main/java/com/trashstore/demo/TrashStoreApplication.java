        ...
        CommandLineRunner seedData(ItemRepository itemRepo, UserRepository userRepo, PasswordEncoder passwordEncoder) {
                return args -> {
                        ...
                        itemRepo.save(new Item("Retro CRT Monitor",
                                        ...
                                        "https://images.unsplash.com/photo-1593640408182-31c228d91eac?w=400",
                                        "Electronics"));
                        ...
                        itemRepo.save(new Item("Scrap Metal Sculpture",
                                        ...
                                        "https://images.unsplash.com/photo-1581781870027-04212e06e0a7?w=400", "Art"));
                        ...
                        itemRepo.save(new Item("Broken Vinyl Records Bundle",
                                        ...
                                        "https://images.unsplash.com/photo-1603048588665-791ca8aea617?w=400", "Music"));
                        ...
                        itemRepo.save(new Item("Rusty Bicycle Bell",
                                        ...
                                        "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400", "Parts"));
                        ...
                        itemRepo.save(new Item("Old Rotary Phone",
                                        ...
                                        "https://images.unsplash.com/photo-1574620023453-d0c44bcb9fa5?w=400",
                                        "Electronics"));
                        ...
                        itemRepo.save(new Item("Wooden Pallet Set",
                                        ...
                                        "https://images.unsplash.com/photo-1601598851547-4302969d0614?w=400", "Wood"));
                        ...
                        itemRepo.save(new Item("Antique Typewriter",
                                        ...
                                        "https://images.unsplash.com/photo-1588412079929-790b9f593d8e?w=400",
                                        "Office"));
                        ...
                        itemRepo.save(new Item("Reclaimed Wood Shelf",
                                        ...
                                        "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=400", "Wood"));

                        // Seed default demo user with hashed password
                        User user = new User("trashmaster", "trash@store.com", new BigDecimal("500.0"));
                        user.setPassword(passwordEncoder.encode("trash123"));
                        userRepo.save(user);
                };
        }
}
